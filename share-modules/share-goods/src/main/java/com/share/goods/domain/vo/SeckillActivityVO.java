...
public class SeckillActivityVO {
    ...
    @Schema(description = "状态(0-未开始 1-进行中)")
    ...
    public static SeckillActivityVO from(SeckillActivity a) {
        ...
        vo.setOriginPrice(null); // 由 service 层填充
        ...
        vo.setSalesCount(0); // 由 service 层计算
        return vo;
    }
}
